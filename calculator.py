...
def equalpress():
    ...
    # if error is generated then handle it by the except block
...
if __name__ == "__main__":
    ...
    # StringVar() is the variable class, creating an instance of this class
    equation = StringVar()
    ...
    # when user press the button, the command or function affiliated to that
    # button is executed
